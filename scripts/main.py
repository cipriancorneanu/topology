...
if args.build_graph:
    ...
    elif args.graph_type=='functional_big_network':
        os.system('python ../build_graph_functional_big_networks.py --save_path '+SAVE_PATH+' --net '+args.net+' --dataset '+args.dataset+' --trial '+args.trial+' --epochs '+args.epochs_test+' --thresholds '+thresholds+' --split '+args.split+' --kl '+args.kl+' --permute_labels '+args.permute_labels+' --binarize_labels '+args.binarize_labels+' --partition '+args.partition)    
    ...
    elif args.graph_type=='functional_big_network_per_partition':
        os.system('python ../build_graph_functional_big_networks_per_partition.py --save_path '+SAVE_PATH+' --net '+args.net+' --dataset '+args.dataset+' --trial '+args.trial+' --epochs '+args.epochs_test+' --thresholds '+thresholds+' --split '+args.split+ ' --subsplit '+args.subsplit+' --kl '+args.kl+' --permute_labels '+args.permute_labels+' --binarize_labels '+args.binarize_labels+' --partition '+args.partition)
...
if args.graph_type=='functional_big_network_per_partition':
    for part in range(int(args.split)):
        os.system('python compute_topology_per_partition.py --save_path '+SAVE_PATH+' --net '+args.net+' --dataset '+args.dataset+' --epochs '+args.epochs_test+' --thresholds '+thresholds+' --trial '+ args.trial + ' --part ' + str(part))
else:
...
if args.graph_type=='functional_big_network_per_partition':
    for part in range(int(args.split)):
        os.system('python prepare_results_big_network_per_partition.py --path '+SAVE_PATH+' --net '+args.net+' --dataset '+args.dataset+' --trial '+args.trial+' --epochs '+args.epochs_test+' --thresholds '+thresholds+' --permute_labels '+args.permute_labels+' --subset '+args.data_subset + ' --split ' + args.split + ' --part ' + str(part))        
else:
